...
<?php
    ...
    if(isset($_SESSION['relatoriodomembro'])):
        $cpfVerify=$_SESSION['cpfrelatoriorapido'];
    ...
    if(isset($_POST['btn-cadastrar'])):
        //if($statusdaempresa === 'APROVADO'):
            ...
            for($anosrepetindo=0; $anosrepetindo < $anosemeses; $anosrepetindo++){
                ...
                elseif(isset($_SESSION['codigodaoperacao']) AND !empty($_SESSION['codigodaoperacao'])):
                                    ...
                                    <div class="title-container-inner">
                                        <div class="row flex">
                                            <div class="column width-12 v-align-middle">
                                                <div>
                                                    <h1 class="mb-0">Enviar relatório.</h1>
                                    ...
                                    <div class="register-form-container">
                                        <form class="login-form" action="<? echo $_SERVER['REQUEST_URI'];?>" method="post" charset="UTF-8">
                                            <div class="row">
                                                ...
                                                <h3 class="color-blue"><strong>Relatório</strong>, para membros cadastrados.</h3>
                                                <div class="column width-12">
                                                ...
                                                ?>
                                                    <div class="column width-12">
                                                        <span class="column full-width box medium rounded border-blue"><strong>Relatório Financeiro</strong>
                                                            <br><a href="relatorio?type=c">Adicionar Receita</a> | <a href="relatorio?type=d">Adicionar Saída</a>
                                                        </span>
                                                    </div>
                                                    <?
                                                        else:
                                                    ...
                                                    <div class="column width-12 pb-20">
                                                        <div class="column full-width bkg-base box medium rounded border-blue"><a href="./logout.php">Sair</a> | <strong>Relatório Financeiro</strong> clique para: <a href="relatorio?type=c">Adicionar Receita</a> | <a href="relatorio?type=d">Adicionar Saída</a>
                                                        </div>
                                                    </div>
                                                    <div class="column width-12">
