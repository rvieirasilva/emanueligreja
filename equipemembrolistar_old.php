                                    ...
                                    <table class="table striped non-responsive rounded medium full-width">
                                        ...
                                        <?php
                                            ...
                                            $pagina = (isset($_GET['pagina']))? $_GET['pagina'] : 1;
                                                ...
                                                $membrosparaeditar= "SELECT id, nome, sobrenome, matricula FROM membros WHERE NOT (nome = '') ORDER BY nome ASC, statusdomembro DESC LIMIT $inicio, $membrosporpagina";
                                        ...
                                        ?>
                                            <tr >
                                                ...
                                                <td class="color-black" width="56%" valign="medium">
                                                    <?php $nomeM=base64_decode($dadosmembrosparaeditar['nome']); $nomeM=base64_decode($nomeM); $sobrenomeM=base64_decode($dadosmembrosparaeditar['sobrenome']); $sobrenomeM=base64_decode($sobrenomeM); echo $nomeM.' '.$sobrenomeM;?> 
                                                </td>
                                                <td width="10%" valign="medium">
                                                    ...
                                                    <center>
                                                        ...
                                                        <a href="equipemembro?m=<?php echo $matricula;?>&id=<?php echo $dadosmembrosparaeditar['id'];?>&<?php echo uniqid();?>&token=<?php echo $token;?>&ref=<?php echo $dadosmembrosparaeditar['matricula'];?>" class="icon-pencil color-black color-charcoal center small thick">
                                                        Editar
                                                        </a>
                                                    </center>
                                                </td>
