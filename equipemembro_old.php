                                                ...
                                                <div class="column width-4 v-align-middle">
                                                    <div>
                                                        <ul class="breadcrumb inline-block mb-0 pull-right clear-float-on-mobile">
                                                            <li>
                                                                <a href="equipemembrolistar<?php if(!empty($linkSeguro)): echo '?'.$linkSeguro; endif;?>">Listar membros</a>
                                                            </li>
                                                            <li>
                        ...
                        <div class="row">
                            ...
                            <div class="box rounded rounded shadow border-blue bkg-white">
                                <div class="column width-12 pt-30">
                                    <form class="form" charset="UTF-8" action="" charset='utf-8' method="post" enctype="multipart/form-data">
                                        <div class="row">
                                            <div class="column width-12">
                                            ...
                                            <div class="column width-3">
                                                ...
                                                <input type="text" name="nome" value="<?php $nomeM=base64_decode($dMe['nome']); echo base64_decode($nomeM); ?>" class="form-fname form-element medium" placeholder="Digite seu primeiro nome (Ele estará em seus certificados e documentos da Emanuel)" tabindex="01" required>
                                            </div>
                                            <div class="column width-3">
                                                <span class="color-charcoal"><strong>SOBRENOME (COMPLETO)</strong></span>
                                                <input type="text" name="sobrenome"  value="<?php $sobrenomeM=base64_decode($dMe['sobrenome']); echo base64_decode($sobrenomeM); ?>" class="form-fname form-element medium" placeholder="Digite seu sobrenome completo (Ele estará em seus certificados e documentos da Emanuel)" tabindex="01" required>
                                            </div>
                                            <div class="column width-3">
                                                <span class="color-charcoal"><strong>CPF</strong></span>
                                                <input type="number" name="cpf"  value="<?php $DocCpf = base64_decode($dMe['cpf']); echo base64_decode($DocCpf); ?>" class="form-fname form-element medium" placeholder="Digite seu sobrenome completo (Ele estará em seus certificados e documentos da Emanuel)" tabindex="01">
                                            </div>
                                            <div class="column width-3">
                                                <span class="color-charcoal"><strong>RG</strong></span>
                                                <input type="number" name="rg"  value="<?php $DocRg = base64_decode($dMe['rg']); echo base64_decode($DocRg); ?>" class="form-fname form-element medium" placeholder="" tabindex="01">
                                            </div>
                                            <div class="column width-4">
                                                <span class="color-charcoal"><strong>E-MAIL</strong></span>
                                                <input type="email" name="email"  value="<?php echo $dMe['email']; ?>" class="form-fname form-element medium" placeholder="E-mail principal" tabindex="02" required>
                                            </div>
                                            <div class="column width-3">
                                            ...
                                            <div class="column width-2">
                                                ...
                                                <input type="tel" name="telefonemovel"  value="<?php $telMov= base64_decode($dMe['telefonemovel']); echo base64_decode($telMov); ?>" class="form-fname form-element medium" placeholder="21 34098021" tabindex="02">
                                            </div>
                                            <div class="column width-3">
                                                <span class="color-charcoal"><strong>WHATSAPP</strong></span>
                                                <input type="tel" name="whatsapp"  value="<?php $whats=base64_decode($dMe['whatsapp']); $whats = base64_decode($whats); ?>" class="form-fname form-element medium" placeholder="21 943098412" tabindex="02">
                                            </div>
                                            <div class="column width-4">
                                            ...
                                            <div class="column width-8">
                                                ...
                                                <input type="text" name="endereco"  value="<?php $endAl = base64_decode($dMe['endereco']); echo base64_decode($endAl); ?>" class="form-fname form-element medium" placeholder="Rua Otávio Peixoto, 320" tabindex="02">
                                            </div>
                                            <div class="column width-3">
                                                <span class="color-charcoal"><strong>CEP</strong></span>
                                                <input type="number" name="cep"  value="<?php $endAl = base64_decode($dMe['cep']); echo base64_decode($endAl); ?>" class="form-fname form-element medium" placeholder="02123453" tabindex="02">
                                            </div>
                                            <div class="column width-3">
                                                ...
                                                <div class="form-select form-element rounded medium">
                                                    <select name="estado" tabindex="6" class="form-aux" data-label="Project Budget">
                                                        ...
                                                        <?php
                                                            $bEt="SELECT nome FROM estado WHERE id='19'";
                                            ...
                                            <div class="column width-3">
                                                ...
                                                <div class="form-select form-element rounded medium">
                                                    <select name="cidade" tabindex="6" class="form-aux" data-label="Project Budget"> 
                                                        ...
                                                        <?php
                                                            $bEt="SELECT nome FROM cidade WHERE estado='19'";
                                                                $rEt=mysqli_query($con, $bEt);
                                                                while($dEt=mysqli_fetch_array($rEt)):
                                                        ?>
                                            ...
                                            <div class="column width-3">
                                                ...
                                                <input type="date" name="nascimento"  value="<?php echo $dMe['nascimento']; ?>" class="form-fname form-element medium" placeholder="" tabindex="02">
                                            </div>
                                            <div class="column width-4">
                                                <span class="color-charcoal"><strong>Pai</strong> (Nome completo)</span>
                                                <input type="text" name="pai"  value="<?php echo $dMe['pai']; ?>" class="form-fname form-element medium" placeholder="Nome do seu pai" tabindex="02">
                                            </div>
                                            <div class="column width-4">
                                                <span class="color-charcoal"><strong>Mãe</strong> (Nome completo)</span>
                                                <input type="text" name="mae"  value="<?php echo $dMe['mae']; ?>" class="form-fname form-element medium" placeholder="Nome da sua mãe." tabindex="02">
                                            </div>
                                            <div class="column width-4">
                                                <span class=" color-charcoal weight-bold pb-10">
                                                    Estado cívil
                                                ...
                                                <div class="form-select form-element rounded medium">
                                                    <select name="estadocivil" tabindex="6" class="form-aux" data-label="Project Budget"> 
                                                        <option selected='selected'><?php echo $dMe['estadocivil']; ?></option>
                                            ...
                                            <div class="column width-3">
                                                ...
                                                <div class="form-select form-element rounded medium">
                                                    <select name="grauescolar" tabindex="6" class="form-aux" data-label="Project Budget"> 
                                                        <option selected='selected'><?php echo $dMe['grauescolar'];?></option>
                                            ...
                                            <div class="column width-3">
                                                ...
                                                <input type="text" name="formadoem"  value="<?php echo $dMe['formadoem']; ?>" class="form-fname form-element medium" placeholder="Administração" tabindex="02">
                                            </div>
                                            <div class="column width-3">
                                                <span class="color-charcoal"><strong>Profissão</strong> atual</span>
                                                <input type="text" name="profissao"  value="<?php echo $dMe['profissao']; ?>" class="form-fname form-element medium" placeholder="Administrador" tabindex="02">
                                            </div>
                                            <div class="column width-3">
                                            ...
                                            <input type="date" name="frequentaemanueldesde"  value="<?php echo $dMe['frequentaaemanueldesde']; ?>" class="form-fname form-element medium" placeholder="16/01/2021" tabindex="02">
                                            </div>
                                            <div class="column width-6">
                                                ...
                                                <div class="column width-12">
                                                    <div class="field-wrapper pt-10 pb-10">
                                                        <input id="radio-membro" <?php if(in_array("Membro", $ministerioprocurado)): echo "checked"; endif;?> class="form-save-card-details form-element radio rounded no-margin-bottom" value="Membro" name="ministerio[]" type="radio"  tabindex="25" >
                                                        <label for="radio-membro" class="radio-label no-margin-bottom">
                                                            Membro
                                                        </label>

                                                        <input id="radio-pastor" <?php if(in_array("Pastor", $ministerioprocurado) OR in_array("Pastora", $ministerioprocurado)): echo "checked"; endif;?>  class="form-save-card-details form-element radio rounded no-margin-bottom" value="Pastor (a)" name="ministerio[]" type="radio"  tabindex="25" >
                                                        <label for="radio-pastor" class="radio-label no-margin-bottom">
                                                            Pastor (a)
                                                        </label>

                                                        <input id="radio-presbitero" <?php if(in_array("Presbítero", $ministerioprocurado)): echo "checked"; endif;?>  class="form-save-card-details form-element radio rounded no-margin-bottom" value="Presbítero" name="ministerio[]" type="radio"  tabindex="25" >
                                                        <label for="radio-presbitero" class="radio-label no-margin-bottom">
                                                            Presbítero
                                                        </label>

                                                        <input id="radio-evangelista" <?php if(in_array("Evangelista", $ministerioprocurado)): echo "checked"; endif;?>  class="form-save-card-details form-element radio rounded no-margin-bottom" value="Evangelista" name="ministerio[]" type="radio"  tabindex="25" >
                                                        <label for="radio-evangelista" class="radio-label no-margin-bottom">
                                                            Evangelista
                                                        </label>

                                                        <input id="radio-diacono" <?php if(in_array("Diacono", $ministerioprocurado) OR in_array("Diáconisa", $ministerioprocurado)): echo "checked"; endif;?> class="form-save-card-details form-element radio rounded no-margin-bottom" value="Diacono (a)" name="ministerio[]" type="radio"  tabindex="25" >
                                            ...
                                            <div class="column width-3">
                                                <span class="color-charcoal"><strong>(Outro)</strong> Consagrado como?</span>
                                                <input type="text" name="ministerio2"  value="" class="form-fname form-element medium" placeholder="Líder de célula" tabindex="02">
                                            </div>
                                            ...
                                            <div class="column width-12 pb-10">
                                                ...
                                                <div class="column width-12">
                                                    <div class="field-wrapper pt-10 pb-10">
                                                        <input id="checkbox-coordenadorderede" <?php if(in_array("Coordenador de rede", $ministerioprocurado) OR in_array("Coordenadora de rede", $ministerioprocurado)): echo "checked"; endif;?> class="form-save-card-details form-element checkbox rounded no-margin-bottom" value="Coordenador (a) de rede" name="ministerio[]" type="checkbox"  tabindex="25" >
                                                        <label for="checkbox-coordenadorderede" class="checkbox-label no-margin-bottom">
                                                            Coordenador (a) de rede
                                                        </label>

                                                        <input id="checkbox-supervisordecelula" <?php if(in_array("Supervisor de célula", $ministerioprocurado) OR in_array("Supervisora de célula", $ministerioprocurado)): echo "checked"; endif;?>  class="form-save-card-details form-element checkbox rounded no-margin-bottom" value="Supervisor (a) de célula" name="ministerio[]" type="checkbox"  tabindex="25" >
                                                        <label for="checkbox-supervisordecelula" class="checkbox-label no-margin-bottom">
                                                            Supervisor (a) de célula
                                                        </label>

                                                        <input id="checkbox-liderderede" <?php if(in_array("Líder de rede", $ministerioprocurado)): echo "checked"; endif;?>  class="form-save-card-details form-element checkbox rounded no-margin-bottom" value="Líder de rede" name="ministerio[]" type="checkbox"  tabindex="25" >
                                                        <label for="checkbox-liderderede" class="checkbox-label no-margin-bottom">
                                                            Líder de rede
                                                        </label>

                                                        <input id="checkbox-liderdecelula" <?php if(in_array("Líder de célula", $ministerioprocurado)): echo "checked"; endif;?>  class="form-save-card-details form-element checkbox rounded no-margin-bottom" value="Líder de célula" name="ministerio[]" type="checkbox"  tabindex="25" >
                                                        <label for="checkbox-liderdecelula" class="checkbox-label no-margin-bottom">
                                                            Líder de célula
                                                        </label>

                                                        <input id="checkbox-secretariodecelula" <?php if(in_array("Secretário de célula", $ministerioprocurado)): echo "checked"; endif;?>  class="form-save-card-details form-element checkbox rounded no-margin-bottom" value="Secretário (a) célula" name="ministerio[]" type="checkbox"  tabindex="25" >
                                                        <label for="checkbox-secretariodecelula" class="checkbox-label no-margin-bottom">
                                                            Secretário (a) de célula
                                                        </label>

                                                        <input id="checkbox-Tesoureirodecelula" <?php if(in_array("Tesoureiro de célula", $ministerioprocurado)): echo "checked"; endif;?>  class="form-save-card-details form-element checkbox rounded no-margin-bottom" value="Tesoureiro (a) célula" name="ministerio[]" type="checkbox"  tabindex="25" >
                                                        <label for="checkbox-Tesoureirodecelula" class="checkbox-label no-margin-bottom">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="column width-3 border-red rounded">
                                                ...
                                                <div class="form-select form-element rounded medium">
                                                    <select name="statusdomembro" tabindex="6" class="form-aux" data-label="Project Budget"> 
                                                        <option selected='selected'><?php echo $dMe['statusdomembro'];?></option>
                                                        <?php
                                            ...
                                            <div class="column width-12 border-orange rounded">
                                                ...
                                                <div class="form-select form-element rounded medium">
                                                    <select name="funcaoadministrativa" tabindex="6" class="form-aux" data-label="Project Budget"> 
                                                        <option selected='selected'><?php echo $dMe['funcaoadministrativa'];?></option>
                                                        <?php
                                            ...
                                            <div class="column width-12">
                                                ...
                                                <div class="column full-width left">
                                                    <div class="field-wrapper pb-10">
                                                        <div class="column width-2">
                                                            <input id="checkbox-missoes" <?php if(in_array("Missões e Social", $serviremqualareaprocurado)): echo "checked"; endif;?> class="form-save-card-details form-element checkbox rounded no-margin-bottom" value="Missões e Social" name="serviremqualarea[]" type="checkbox"  tabindex="25"/>
                                                            <label for="checkbox-missoes" class="left checkbox-label no-margin-bottom">
                                                                Missões e Social
                                                            </label>
                                                        </div>
                                                        <div class="column width-2">
                                                            <input id="checkbox-kids" <?php if(in_array("IBE Kids", $serviremqualareaprocurado)): echo "checked"; endif;?>  class="form-save-card-details form-element checkbox rounded no-margin-bottom" value="IBE Kids" name="serviremqualarea[]" type="checkbox"  tabindex="25"/>
                                                            <label for="checkbox-kids" class="left checkbox-label no-margin-bottom">
                                                                IBE Kids
                                                            </label>
                                                        </div>
                                                        <div class="column width-2">
                                                            <input id="checkbox-homens" <?php if(in_array("Homens", $serviremqualareaprocurado)): echo "checked"; endif;?> class="form-save-card-details form-element checkbox rounded no-margin-bottom" value="Homens" name="serviremqualarea[]" type="checkbox"  tabindex="25"/>
                                                            <label for="checkbox-homens" class="left checkbox-label no-margin-bottom">
                                                                Homens
                                                            </label>
                                                        </div>
                                                        <div class="column width-2">
                                                            <input id="checkbox-mulheres" <?php if(in_array("Mulheres", $serviremqualareaprocurado)): echo "checked"; endif;?> class="form-save-card-details form-element checkbox rounded no-margin-bottom" value="Mulheres" name="serviremqualarea[]" type="checkbox"  tabindex="25"/>
                                                            <label for="checkbox-mulheres" class="left checkbox-label no-margin-bottom">
                                                                Mulheres
                                                            </label>
                                                        </div>
                                                        <div class="column width-2">
                                                            <input id="checkbox-Jovens" <?php if(in_array("Jovens", $serviremqualareaprocurado)): echo "checked"; endif;?> class="form-save-card-details form-element checkbox rounded no-margin-bottom" value="Jovens" name="serviremqualarea[]" type="checkbox"  tabindex="25"/>
                                                            <label for="checkbox-Jovens" class="left checkbox-label no-margin-bottom">
                                                                Jovens
                                                            </label>
                                                        </div>
                                                        <div class="column width-2">
                                                            <input id="checkbox-adolescentes" <?php if(in_array("Adolcescentes", $serviremqualareaprocurado)): echo "checked"; endif;?> class="form-save-card-details form-element checkbox rounded no-margin-bottom" value="Adolescentes" name="serviremqualarea[]" type="checkbox"  tabindex="25"/>
                                                            <label for="checkbox-adolescentes" class="left checkbox-label no-margin-bottom">
                                                                Adolescentes
                                                            </label>
                                                        </div>
                                                        <div class="column width-2">
                                                            <input id="checkbox-infraestrutura" <?php if(in_array("Infraestrutura", $serviremqualareaprocurado)): echo "checked"; endif;?> class="form-save-card-details form-element checkbox rounded no-margin-bottom" value="Infraestrutura" name="serviremqualarea[]" type="checkbox"  tabindex="25"/>
                                                            <label for="checkbox-infraestrutura" class="left checkbox-label no-margin-bottom">
                                                                Infraestrutura
                                                            </label>
                                                        </div>
                                                        <div class="column width-2">
                                                            <input id="checkbox-midiasecomunicacao" <?php if(in_array("Mídias", $serviremqualareaprocurado)): echo "checked"; endif;?> class="form-save-card-details form-element checkbox rounded no-margin-bottom" value="Mídias" name="serviremqualarea[]" type="checkbox"  tabindex="25"/>
                                                            <label for="checkbox-midiasecomunicacao" class="left checkbox-label no-margin-bottom">
                                                                Mídias
                                                            </label>
                                                        </div>
                                                        <div class="column width-2">
                                                            <input id="checkbox-negocioeempreendimentos" <?php if(in_array("Business", $serviremqualareaprocurado)): echo "checked"; endif;?> class="form-save-card-details form-element checkbox rounded no-margin-bottom" value="Business" name="serviremqualarea[]" type="checkbox"  tabindex="25"/>
                                                            <label for="checkbox-negocioeempreendimentos" class="left checkbox-label no-margin-bottom">
                                                                Business
                                                            </label>
                                                        </div>

                                                        <div class="column width-2">
                                                            <input id="checkbox-danca" <?php if(in_array("Dança", $serviremqualareaprocurado)): echo "checked"; endif;?> class="form-save-card-details form-element checkbox rounded no-margin-bottom" value="Dança" name="serviremqualarea[]" type="checkbox"  tabindex="25"/>
                                                            <label for="checkbox-danca" class="left checkbox-label no-margin-bottom">
                                                                Dança
                                                            </label>
                                                        </div>
                                                        <div class="column width-2">
                                                            <input id="checkbox-celulas" <?php if(in_array("Células", $serviremqualareaprocurado)): echo "checked"; endif;?> class="form-save-card-details form-element checkbox rounded no-margin-bottom" value="Células" name="serviremqualarea[]" type="checkbox"  tabindex="25"/>
                                                            <label for="checkbox-celulas" class="left checkbox-label no-margin-bottom">
                                                                Células
                                                            </label>
                                                        </div>
                                                        <div class="column width-2">
                                                            <input id="checkbox-educacao" <?php if(in_array("Educação", $serviremqualareaprocurado)): echo "checked"; endif;?> class="form-save-card-details form-element checkbox rounded no-margin-bottom" value="Educação" name="serviremqualarea[]" type="checkbox"  tabindex="25"/>
                                                            <label for="checkbox-educacao" class="left checkbox-label no-margin-bottom">
                                                                Educação
                                                            </label>
                                                        </div>
                                                        <div class="column width-2">
                                                            <input id="checkbox-musica" <?php if(in_array("Música", $serviremqualareaprocurado)): echo "checked"; endif;?> class="form-save-card-details form-element checkbox rounded no-margin-bottom" value="Música" name="serviremqualarea[]" type="checkbox"  tabindex="25"/>
                                                            <label for="checkbox-musica" class="left checkbox-label no-margin-bottom">
                                                                Música
                                                            </label>
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="column width-3">
                                                ...
                                                <input type="number" name="numerodefamiliaresnaemanuel"  value="<?php echo $dMe['numerodefamiliaresnaemanuel']; ?>" class="form-fname form-element medium" placeholder="3" tabindex="02">
                                            </div>
                                            <div class="column width-3">
                                                <span class="color-charcoal">Data do <strong>batismo</strong> </span>
                                                <input type="date" name="datadobatismo"  value="<?php echo $dMe['datadobatismo']; ?>" class="form-fname form-element medium" placeholder="01/04/2020" tabindex="02">
                                            </div>
                                            <div class="column width-3">
                                                <span class="color-charcoal">Igreja do <strong>batismo</strong></span>
                                                <input type="text" name="igrejadebatismo"  value="<?php echo $dMe['igrejadebatismo']; ?>" class="form-fname form-element medium" placeholder="Igreja Emanuel" tabindex="02">
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="column width-3">
                                                ...
                                                <div class="form-select form-element rounded medium">
                                                    <select name="midiasocial1" tabindex="6" class="form-aux" data-label="Project Budget"> 
                                                        <option selected='selected'><?php echo $dMe['midiasocial1'];?></option>
                                            ...
                                            <div class="column width-9">
                                                ...
                                                <input type="text" name="link1"  value="<?php $link1 = base64_decode($dMe['link1']); echo base64_decode($link1); ?>" class="form-fname form-element medium" placeholder="instagram.com/emanueligrejabr" tabindex="02">
                                            </div>
                                            <div class="column width-3">
                                                <span class=" color-charcoal weight-bold pb-10">
                                                ...
                                                <div class="form-select form-element rounded medium">
                                                    <select name="midiasocial2" tabindex="6" class="form-aux" data-label="Project Budget"> 
                                                        <option selected='selected'><?php echo $dMe['midiasocial2'];?></option>
                                                        <option value="facebook">Facebook</option>
                                                        <option value="instagram">Instagram</option>
                                                        <option value="youtube">Youtube</option>
                                                        <option value="twitter">Twitter</option>
                                            ...
                                            <div class="column width-9">
                                                <span class="color-charcoal">Link do seu perfil nessa mídia <strong>social</strongspan/label>
                                                <input type="text" name="link2"  value="<?php $link2 = base64_decode($dMe['link2']); echo base64_decode($link2); ?>" class="form-fname form-element medium" placeholder="youtube.com/emanueligrejabr" tabindex="02">
                                            </div>
                                            <div class="column width-3">
                                                <span class=" color-charcoal weight-bold pb-10">
                                                ...
                                                <div class="form-select form-element rounded medium">
                                                    <select name="midiasocial3" tabindex="6" class="form-aux" data-label="Project Budget"> 
                                                        <option selected='selected'><?php echo $dMe['midiasocial3'];?></option>
                                                        <option value="facebook">Facebook</option>
                                                        <option value="instagram">Instagram</option>
                                                        <option value="youtube">Youtube</option>
                                                        <option value="twitter">Twitter</option>
                                            ...
                                            <div class="column width-9">
                                                <span class="color-charcoal">Link do seu perfil nessa mídia <strong>social</strongspan/label>
                                                <input type="text" name="link3"  value="<?php $link3 = base64_decode($dMe['link3']); echo base64_decode($link3); ?>" class="form-fname form-element medium" placeholder="twitter.com/emanueligrejabr" tabindex="02">
                                            </div>
                                            <div class="column width-3">
                                                <span class=" color-charcoal weight-bold pb-10">
                                                ...
                                                <div class="form-select form-element rounded medium">
                                                    <select name="midiasocial4" tabindex="6" class="form-aux" data-label="Project Budget"> 
                                                        <option selected='selected'><?php echo $dMe['midiasocial4'];?></option>
                                                        <option value="facebook">Facebook</option>
                                                        <option value="instagram">Instagram</option>
                                                        <option value="youtube">Youtube</option>
                                                        <option value="twitter">Twitter</option>
                                            ...
                                            <div class="column width-9">
                                                <span class="color-charcoal">Link do seu perfil nessa mídia <strong>social</strongspan/label>
                                                <input type="text" name="link4"  value="<?php $link4 = base64_decode($dMe['link4']); echo base64_decode($link4); ?>" class="form-fname form-element medium" placeholder="faecebook.com/emanueligrejabr" tabindex="02">
                                            </div>
                                            <div class="column width-12">
                                                ...
                                                <textarea type="text" name="descricaodomembro" class="form-fname form-element medium" placeholder="Pastor, Administrador, Pós graduado em Finanças pela FGV, casado e apaixonado por apresentar a pessoa de Cristo." tabindex="02"><?php echo $dMe['descricaodomembro']; ?></textarea>
                                            </div>
                                            <div class="column width-12">
                                            ...
                                            <div class="column width-12 border-theme pt-20 pb-20">
                                                <span class="center color-charcoal">PARA FINALIZAR <strong>RESOLVA O CÁLCULO ABAIXOspan/strong></label>
                                        ...
                                        <div class="row">
                                            <div class="column width-12 pt-20">
                                                <button tabindex="04" type="submit" name="btn-cadastrar" class="form-submit button small rounded bkg-blue bkg-hover-blue-light color-white color-hover-white hard-shadow">finalizar</button>
