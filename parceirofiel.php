	...
	?>
            <div class="screen">
                <div class="content clearfix">
                                        ...
                                        <div class="title-container-inner">
                                            <div class="row flex">
                                                <div class="column width-8 v-align-middle">
                                                    <div>
                                                        <h1 class="mb-0"><strong>Parceiro</strong> Ministerial</h1>
                                                        <p class="text-large color-charcoal mb-0 mb-mobile-20">Acreditamos que como igreja podemos servir além do ambiente de culto. E você, acredita? Então nos ajude nessa missão.</p>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                    ...
                    <!-- <div class="section-block intro-title pt-150 small">
                        <div class="row">
                            <div class="column width-12">
                                <div class="title-container">
                                    <div class="title-container-inner">
                                        <div class="row flex">
                                            <div class="column width-8 v-align-middle">
                                                <div>
                                                    <h1 class="mb-0 pb-10">
                                                        Construindo por todos
                                                    </h1>
                                                    <p class="lead mb-0 mb-mobile-20 color-charcoal" align="justify">
                                            ...
                                            <div class="column width-4 v-align-middle">
                                                <div>
                                                    <ul class="breadcrumb inline-block mb-0 pull-right clear-float-on-mobile">
                                                        <li>
                                                            <a href="https://igrejaemanuel.com.br">Inicio</a>
                                                        </li>
                                                        <li>
                                                            Construindo por todos
                                                        </li>
                    ...
                    <!-- Content Section -->
                    <div class="section-block intro-title bkg-grey-ultralight color-charcoal pt-150">
                        <div class="row">
                            <div class="column width-3">
                                <h3 class="mb-50 pt-20 weight-bold">
                                    SEJA UM PARCEIRO MINISTERIAL
                                </h3>
                            </div>
                            <div class="column width-9">
                                <p class="color-charcoal text-xlarge" align="justify">Não estamos construindo uma mudança de curto prazo, começamos visando o médio/longo prazo que é<strong> mantida pelo recurso de cada pessoa que quer promover a mudança na forma de ser igreja</strong>. Contamos com você.</p>
                            </div>
                        </div>
                    </div>
                    <!-- Content Section End -->
                    ...
                    <!-- Pricing Options -->
                    <div class="section-block pt-20 bkg-grey-ultralight">
                                ...
                                <div class="pricing-table rounded medium style-3 columns-1 mb-0">
                                    <div class="pricing-table-column mb-mobile-30 bkg-white">
                                        <div class="pricing-table-header">
                                            <h2 class="weight-bold">Parceiro Fiel - Constante</h2>
                                        </div>
                            ...
                            <div class="column width-8">
                                <div class="pricing-table rounded medium style-3 columns-1 mb-0">
                                    <div class="pricing-table-column mb-mobile-30 bkg-blue">
                                        <div class="pricing-table-header">
                                            <h2 class="color-white"><strong>Parceiro Fiel - Coríntios</strong> <span class="text-medium"> (Escolha um valor acima de:)</span></h2> 
                                        </div>
                                        <div class="pricing-table-price color-white">
                                        ...
                                        <div class="pricing-table-footer">
                                        <a href="https://www.mercadopago.com.br/subscriptions/checkout?preapproval_plan_id=2c938084816dca930181865c317d0757" >
                                            <button class='bkg-white bkg-hover-white color-blue color-hover-blue rounded hard-shadow'>QUERO SER PARCEIRO</button>
                                        </a>
                                            <label class="text-medium color-white pt-10"><a href="https://www.mercadopago.com.br/subscriptions/checkout?preapproval_plan_id=2c938084816dca930181865c317d0757">Clique aqui</a>, caso o botão não funcione.</label>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <!-- ITL -->
                    <div class="section-block pb-10 pb-20 bkg-blue">
                        <div class="row flex">
                    ...
                    <!-- Tamar -->
                    <div class="section-block pb-10 pb-20 bkg-youtube">
                        <div class="row flex">
                            <div class="column width-12 v-align-middle">
                                <div>
                    ...
                    <!-- Moisés -->
                    <div class="section-block pb-10 pb-20 bkg-turquoise">
                        <div class="row flex">
                            <div class="column width-12 v-align-middle">
                                <div>
                    ...
                    <!-- Boaz -->
                    <div class="section-block pb-10 pb-20 bkg-ash">
                        <div class="row flex">
                            <div class="column width-12 v-align-middle">
                                <div>
                    ...
                    <!-- Carousel Slider -->
                    <div class="section-block replicable-content recent-carousel bkg-white">
                        <div class="row">
                    ...
                    <div class="section-block pb-100">
                        <div class="row">
                            <div class="column width-12">
