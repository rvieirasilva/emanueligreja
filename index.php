...
<body class="shop blog home-page">
	...
	?>
			...
			<div class="content clearfix">
				...
				<section id="home" class="section-block hero-5 mb-0 window-height right show-media-column-on-mobile bkg-blue color-white">
					<div class="row">
						<div class="column width-5 window-height background-none">
							<div class="tm-slider-container content-slider window-height v-align-middle" data-nav-arrows="false" data-progress-bar="false" data-scale-under="0" data-width="722">
								<ul class="tms-slides">
									<?php
									...
									<li class="tms-slide">
										...
										<? else: ?>
											...
											<!-- <div class='mejs-container'> -->
												<video controls muted preload="metadata" loading='lazy' poster="<? echo $dVideo['capa']; ?>">
													<source type='video/mp4' src='<? echo $dVideo['video']; ?>?autoplay=0'>
													<source type='video/ogg' src='<? echo $dVideo['video']; ?>?autoplay=0'>
													<source type='video/webm' src='<? echo $dVideo['video']; ?>?autoplay=0'>
						...
						<div class="column width-5 offset-1">
							<div class="hero-content split-hero-content">
								<div class="hero-content-inner left horizon" data-animate-in="preset:slideInRightShort;duration:1000ms;" data-threshold="0.5">
									<h1 class="mb-0 pt-0"><strong>Vem conhecer Jesus.</strong><br></h1>
				...
				<div class="section-block large bkg-white clear-height">
					<!-- <div class="media-overlay bkg-white opacity-04"></div> -->
								...
								<div class="column width-12">
									<div class="row grid content-grid-3">
										<?php     
											$mesdoevento='-'.date('m').'-';
											if(!isset($_SESSION['membro'])):
												$bMais = "SELECT video, miniatura, evento, codigodoevento, datadoinicio, datadotermino, valor FROM agenda WHERE ano='$ano' AND visibilidade='Externo' GROUP BY codigodoevento ORDER BY datadoinicio ASC";
											else:
