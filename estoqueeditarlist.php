                                        ...
                                        <div class="title-container-inner">
                                            <div class="row flex">
                                                <div class="column width-8 v-align-middle">
                                                    <div>
                                                        <h1 class="mb-0">Editar <strong>itens do estoque</strong></h1>
                                    ...
                                    <table class="table striped non-responsive rounded medium full-width">
                                        ...
                                        <?php
                                            ...
                                            $pagina = (isset($_GET['pagina']))? $_GET['pagina'] : 1;
                                                ...
                                                $buscarporconceitos= "SELECT id FROM estoque WHERE NOT (produto = '')  ORDER BY id DESC";
                                                ...
                                                $EstEdit= "SELECT id, dia, mes, ano, codigodoestoque, produto, situacaodoproduto, validade FROM estoque WHERE NOT (codigodoestoque = '') ORDER BY produto ASC, validade ASC LIMIT $inicio, $conceitosporpagina";
                                                    $resultadoEstEdit = mysqli_query($con   , $EstEdit);
                                                            $linha=0;
                                                        while($dEstEdit = mysqli_fetch_array($resultadoEstEdit)):
                                                            $linha++;
                                        ?>
                                            <tr >
                                                ...
                                                <td class="color-black" width="15%" valign="medium">
                                                        <?php echo $dEstEdit['ano'].'-'.$dEstEdit['mes'].'-'.$dEstEdit['dia'].' | Val: '.$dEstEdit['validade'];?> 
                                                </td>
                                                <td class="color-black" width="15%" valign="medium">
                                                        <?php echo $dEstEdit['codigodoestoque'];?> 
                                                </td>
                                                <td class="color-black" width="35%" valign="medium">
                                                        <?php echo $dEstEdit['produto'].' ('.$dEstEdit['situacaodoproduto'].')';?> 
                                                </td>
                                                <td width="15%" valign="medium">
                                                    <center>
                                                        <a href="estoquebaixa?<?php echo $linkSeguro;?>&idb=<?php echo $dEstEdit['codigodoestoque'];?>" class="color-black color-charcoal center small thick">
                                                            Dar baixa
                                                        </a>
                                                    </center>
                                                </td>
                                                <td width="15%" valign="medium">
                                                    <center>
                                                        <a href="./estoqueeditar?<?php echo $linkSeguro;?>&ref=<?php echo $dEstEdit['codigodoestoque'];?>" class="icon-pencil color-black color-charcoal center small thick">
                                                            Editar
                                                        </a>
                                                    </center>
                                                </td>
