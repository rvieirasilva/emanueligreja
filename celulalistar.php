                                    ...
                                    <table class="table striped non-responsive rounded medium full-width">
                                        ...
                                        <?php
                                            ...
                                            $pagina = (isset($_GET['pagina']))? $_GET['pagina'] : 1;
                                                ...
                                                $buscarporconceitos= "SELECT id FROM celulas WHERE NOT (lider = '')  ORDER BY id DESC";
                                                ...
                                                $conceitosparaeditar= "SELECT id, celula, rededacelula, lider FROM celulas WHERE NOT (lider = '') ORDER BY rededacelula DESC LIMIT $inicio, $conceitosporpagina";
                                        ...
                                        ?>
                                            <tr >
                                                ...
                                                <td class="color-black" width="42%" valign="medium">
                                                        <?php echo $dadosconceitosparaeditar['celula'];?> 
                                                </td>
                                                <td class="color-black" width="15%" valign="medium">
                                                        <?php echo $dadosconceitosparaeditar['rededacelula'];?> 
                                                </td>
                                                <td class="color-black" width="30%" valign="medium">
                                                        <?php echo base64_decode(base64_decode($dadosconceitosparaeditar['lider']));?> 
                                                </td>
                                                <td width="20%" valign="medium">
                                                    <center>
                                                        <a href="celulaeditar?m=<?php echo $matricula;?>&exc&id=<?php echo $dadosconceitosparaeditar['id'];?>&token=<?php echo $token;?>" class="icon-pencil color-black color-charcoal center small thick">
                                                            Editar
                                                        </a>
                                                    </center>
                                                </td>
