                                    ...
                                    <div class="column width-12">
                                        <div class="row grid content-grid-3">
                                            <?php    
                                                ...
                                                $bMais = "SELECT referencia, titulo, textoancora, miniatura, video, categoria, datadapostagem, capa, visualizacoes FROM blog WHERE datadapostagem <= '$dataHora' AND categoria='Teologia' GROUP BY referencia ORDER BY datadapostagem DESC LIMIT $inicio, $postsporpagina";
