...
<li class="">
    ...
    <ul class="sub-menu"> 
        ...
        <li>
            ...
            <ul class="sub-menu">
                <?php
                    if($funcaoadministrativa === 'Presidente' OR $funcaoadministrativa === "Tesoureiro" OR $funcaoadministrativa === "II Tesoureiro"):
                ?>
                    <li>
                ...
                <li>
                    <a href="analise?<?php if(!empty($linkSeguro)): echo $linkSeguro; endif;?>">Análise financeira</a>
                        ...
                        <?php
                            ...
                            if($funcaoadministrativa == 'Presidente' OR $funcaoadministrativa == "Vice Presidente" OR $funcaoadministrativa == "Secretário" OR $funcaoadministrativa == "Secretária" OR $funcaoadministrativa == "II Vice Presidente" OR $funcaoadministrativa == "II Secretário" OR $ministerio == "Coordenador de rede" OR $ministerio == "Líder de rede"):
                        ?>
                            <li>
                        ...
                        <li>
                            ...
                            <ul class="sub-menu">
                                ...
                                <li>
                                    <a href="redecadastrar?<?php if(!empty($linkSeguro)): echo $linkSeguro; endif;?>">Publicar página de Rede</a>
                                </li>
                                <li>
                                    <a href="redeeditar?<?php if(!empty($linkSeguro)): echo $linkSeguro; endif;?>">Editar página de Rede</a>
                                </li>
                            </ul>
                        </li>
                    <?php
