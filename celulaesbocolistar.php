...
<?php
    ...
    if(isset($_GET['exc'])):
        ...
        $excluir="DELETE FROM blog WHERE id='$iddopostexcluir' AND referencia='$refparaexc'";
                                        ...
                                        <div class="title-container-inner">
                                            <div class="row flex">
                                                <div class="column width-8 v-align-middle">
                                                    <div>
                                                        <h1 class="mb-0">Editar esboço de <strong>célula</strong></h1>
                                    ...
                                    <table class="table striped non-responsive rounded medium full-width">
                                        ...
                                        <?php
                                            ...
                                            $pagina = (isset($_GET['pagina']))? $_GET['pagina'] : 1;
                                                ...
                                                $buscarporposts= "SELECT id FROM blog WHERE categoria='Esboço de célula' ORDER BY id DESC";
                                                ...
                                                $postsparaeditar= "SELECT * FROM blog WHERE categoria='Esboço de célula' group BY referencia ORDER BY datadapostagem DESC LIMIT $inicio, $postsporpagina";
                                        ...
                                        ?>
                                            <tr class="">
                                                ...
                                                <td width="5%" valign="medium">
                                                    <center>
                                                    <a href="bloglist?m=<?php echo $matricula;?>&exc&id=<?php echo $dadospostsparaeditar['id'];?>&token=<?php echo $token;?>&ref=<?php echo $dadospostsparaeditar['referencia'];?>&titulo=<?php echo $dadospostsparaeditar['titulo'];?>"><span class="color-black">Excluir</span></a>
                                                </td>
                                            </tr>
                                            <?php endwhile; ?>
                                        </tbody>
