                                        ...
                                        <div class="title-container-inner">
                                            <div class="row flex">
                                                <div class="column width-8 v-align-middle">
                                                    <div>
                                                        <h1 class="mb-0">Editar <strong>frase</strong></h1>
                                        ...
                                        <table class="table striped non-responsive rounded medium full-width">
                                            ...
                                            <?php
                                                ...
                                                $pagina = (isset($_GET['pagina']))? $_GET['pagina'] : 1;
                                                    ...
                                                    $buscarporconceitos= "SELECT * FROM conceitos WHERE NOT (conceito = '') AND postadopor= '$nomedousuario' ORDER BY id DESC";
                                                    ...
                                                    $conceitosparaeditar= "SELECT * FROM conceitos WHERE NOT (conceito = '') AND postadopor= '$nomedousuario' ORDER BY postadoem DESC LIMIT $inicio, $conceitosporpagina";
                                                        $resultadoconceitosparaeditar = mysqli_query($con   , $conceitosparaeditar);
                                                            ...
                                                            while($dadosconceitosparaeditar = mysqli_fetch_array($resultadoconceitosparaeditar)):
                                                                ...
                                                                $converterdata = $dadosconceitosparaeditar['postadoem'];
                                            ...
                                            ?>
                                                <tr >
                                                    ...
                                                    <td class="color-black" width="56%" valign="medium">
                                                        <?php echo $dadosconceitosparaeditar['conceito'];?> 
                                                    </td>
                                                    <td class="color-black" width="12%" valign="medium">
                                                        <?php echo $dadosconceitosparaeditar['autor'];?> 
                                                    </td>
                                                    <td class="color-black" width="10%" valign="medium">
                                                        <?php echo $converterdata;?> 
                                                    </td>
                                                    <td width="10%" valign="medium">

                                                        <center>
                                                            <a href="fraseeditar?m=<?php echo $matricula;?>&exc&id=<?php echo $dadosconceitosparaeditar['id'];?>&<?php echo uniqid();?>&token=<?php echo $token;?>&ref=<?php echo $dadosconceitosparaeditar['referencia'];?>" class="icon-pencil color-black color-charcoal center small thick">
                                                            Editar
                                                            </a>
                                                        </center>
                                                    </td>
                                                    <td width="8%" valign="medium">
                                                        ...
                                                        <span class="color-black">
                                                            <a class="color-black" href="fraselistar?m=<?php echo $matricula;?>&exc&id=<?php echo $dadosconceitosparaeditar['id'];?>&<?php echo uniqid();?>&token=<?php echo $token;?>&ref=<?php echo $dadosconceitosparaeditar['referencia'];?>">
                                                            Excluir
                                                            </a>
                                                        </span>
                                                    </td>
